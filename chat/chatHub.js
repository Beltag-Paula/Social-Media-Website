...
const MAX_MESSAGES_PER_WINDOW = 15; // rate limit: chat-flood / spam-bot guard
const WINDOW_MS = 10 * 1000;
const HEARTBEAT_MS = 30 * 1000;

// Minimal cookie parser — avoids pulling in a dependency just for the
// upgrade handshake, which happens before Express (and cookie-parser) ever
// sees the request.
...
function attachChatServer(httpServer) {
  ...
  // Drops dead connections (closed laptop lid, lost network, etc.) that
